...
### `@estrategista-turbo` · Orquestrador estratégico
...
### `@pesquisador-turbo` · Camada fundacional interna
...
| Skill | Por quê |
|---|---|
| `brand` | Identidade · tom · style guide |
| `design` | Design completo (paleta, tokens, logo) |
| `design-system` | Token architecture · component specs |
| `design-tokens-turbo` | Camada Turbo de tokens (OKLCH · 4/8pt · 1.25) |
| `ui-ux-pro-max` | UX heurísticas · 50+ estilos · 161 paletas |
| `web-design-guidelines` | Auditoria contra Web Interface Guidelines |
...
| `ui-styling` | shadcn/ui · Tailwind · Radix |
| `brand` | Aplicar identidade |
| `design` | Toda execução de design |
| `design-system` | Aplicar tokens consistentes |
...
| Skill | Por quê |
|---|---|
| `frontend-design` | Pensar como designer (Anthropic) |
| `impeccable` | 18 comandos de polimento (Paul Bakaus) |
| `design-motion-principles` | 3 lentes de motion (Kyle Zantos) |
| `web-design-guidelines` | Auditoria contra Web Interface Guidelines |
| `ui-ux-pro-max` | Heurísticas UX abrangentes |

---

## 🔁 Por skill (cross-reference)

> Onde cada skill aparece. Skills compartilhadas aparecem em múltiplos agents — cada um usa por um ângulo diferente.
...
| Skill | Agents |
|---|---|
| `frontend-design` | diretor-criativo · designer · picasso |
| `impeccable` | diretor-criativo · picasso |
| `design-motion-principles` | diretor-criativo · picasso |
...
| Skill | Agents |
|---|---|
| `brand` | diretor-criativo · designer |
| `design` | diretor-criativo · designer |
| `design-system` | diretor-criativo · designer |
...
## 📦 Skills NÃO atribuídas a agents Turbo (uso direto)

Estas skills são utilitárias, técnicas ou de infraestrutura · não fazem sentido vincular a agent específico:

- `deploy-to-vercel` · deploy direto
- `vercel-cli-with-tokens` · auth Vercel
- `vercel-composition-patterns` · padrões React
...
## 🧭 Como esta matriz foi montada

1. Inventário das 45 skills locais (`~/.claude/skills/`)
